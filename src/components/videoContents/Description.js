...
import ovalFood from "assets/icons/ovalFood.svg";
...
const Description = () => {
  return (
    <Wrapper>
      <DescriptionWrapper>
        <TopSection>
          <Desc>Dude You Re Getting A Telescope</Desc>
          <MidSection>
            <Views>123k Views</Views>
            <LikeWrapper>
              <Likes>
                <Icon>
                  <svg
        ...
        <BottomSection>
          ...
          <Txt>
            ...
            <Published>Published on 14 Jun 2019</Published>
            <DescTxt>
